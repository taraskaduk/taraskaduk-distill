...
<Aside>
```{r echo=FALSE}
tweetrmd::tweet_embed("https://twitter.com/taraskaduk/status/1207680875472789505")
```
</Aside>
...
```{r ggsave}
ggsave("map.png", plot=p, width = 297, height = 420, units = "mm", dpi = "retina")
...
This is pretty much it! From here, you can take the file into a program that works with vector images (e.g. Adobe Illustrator, Affinity, Inkspace, Affinity Designer et cetera) to further tweak it by hand before ordering prints.
